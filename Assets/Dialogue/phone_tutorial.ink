...
According to vampire code, if they do not have consent or a legal warrant to search, then they cannot enter private property. #PHONE #{delay}
...
Now we're at the part of your job where you have to make a choice. #PHONE #{delay}
...
Down there is the report function. When you are watching an interaction, you can report the involved vampire at any time. Don't use it if the vampire doesn't break code. #PHONE #{delay}
